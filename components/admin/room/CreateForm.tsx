            ...
            <div className="grid md:grid-cols-2 gap-3">
              {amenities.map((item) => (
                <div className="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition-colors duration-200" key={item.id}>
                  <input type="checkbox" value={item.id} name="amenities" className="w-4 h-4 text-blue-600 bg-white border-gray-300 rounded focus:ring-blue-500 focus:ring-2" />
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6">
            ...
            >
              <div className="flex flex-col items-center justify-center text-gray-500 z-10 p-4">
                ...
                {image ? (
                  <button type="button" onClick={() => deleteImage(image)} className="flex items-center justify-center bg-red-500 size-8 rounded-full absolute top-3 right-3 text-white hover:bg-red-600 transition-colors duration-200 z-20">
                  ...
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-sm font-medium text-gray-700 mb-1">Pilih Gambar</p>
